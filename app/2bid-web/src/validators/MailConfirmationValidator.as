package validators
{
    ...
    public class MailConfirmationValidator extends Validator
    {
    	// Define Array for the return value of doValidation().
        private var results:Array;

    	public function MailConfirmationValidator()
    	{
    		super();
    	}
        ...
        override protected function doValidation(value:Object):Array {
    		...
    		var results:Array = super.doValidation(value.email);
    	...
    	override protected function getValueFromSource():Object
    	{
    		...
    		value.email = super.getValueFromSource();
